    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-96 relative">
                ...
                <div className="mb-4">
                    <div className="block text-sm font-medium text-gray-700 mb-1">{t('owner')}</div>
                ...
                <div className="mb-4">
                    <div className="text-sm font-medium text-gray-700 mb-6">{t('members')} {data.userList.length}</div>
